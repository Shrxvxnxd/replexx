...
const ownerids = ["781882376790736937","651110672087908384", "844843800874582048", "703949805457637471","798871663704932402","884070608181297172","789803145386655756"]
       ...
       return interaction.message.delete()
        ...
        if (interaction.customId === 'shuffle') {
            ...
            let thing = new MessageEmbed()
                ...
                .setDescription(`he queue has been shuffled. - <@!${interaction.member.id}>`)
                .setColor(client.embedColor)
                return await interaction.channel.send({embeds: [thing]}).then(responce => {
                    setTimeout(() => {
                        try {
